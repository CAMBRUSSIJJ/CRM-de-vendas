...
(function(){
  ...
  const VIEWS = [
    ...
    {id:'pipeline', label:'Pipeline', icon:'▦', subs:[['Kanban','pipeline'],['Funil','dashboard'],['Configurar etapas','pipeline']]},
    ...
    {id:'playbooks', label:'Inteligência', icon:'✦', subs:[['Playbooks','playbooks'],['Scripts','playbooks'],['Objeções','objecoes'],['Assistente de scripts','playbooks']]},
